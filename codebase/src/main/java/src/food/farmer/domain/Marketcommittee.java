...
@Table(name = "marketcommittee")
public class Marketcommittee implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Marketcommittee marketcommittee = (Marketcommittee) o;
        if(marketcommittee.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, marketcommittee.id);
    }
