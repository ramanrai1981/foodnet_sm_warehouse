package src.food.farmer.web.websocket;

import src.food.farmer.security.SecurityUtils;
import src.food.farmer.web.websocket.dto.ActivityDTO;
...
import static src.food.farmer.config.WebsocketConfiguration.IP_ADDRESS;
