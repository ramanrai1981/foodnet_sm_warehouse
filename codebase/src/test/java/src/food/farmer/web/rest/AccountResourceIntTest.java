...
import src.food.farmer.AbstractCassandraTest;
import src.food.farmer.FarmerApp;
import src.food.farmer.domain.User;
import src.food.farmer.repository.UserRepository;
import src.food.farmer.security.AuthoritiesConstants;
...
@SpringApplicationConfiguration(classes = FarmerApp.class)
@WebAppConfiguration
@IntegrationTest
